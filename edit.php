...
$data = mysqli_query($conn, "SELECT * FROM tb_pendaftar WHERE npm = $npm");
...
<main class="form-signin">
  <form method="post" action="">
    ...
    <div class="form-floating">
      <input type="text" name="npm" class="form-control" id="floatingInput" placeholder="NPM" autocomplete="off" value="<?= $result['npm']; ?>">
      <label for="floatingInput">NPM</label>
    </div>
    <br>
     <div class="form-floating">
      <input type="text" name="nama" class="form-control" id="floatingInput" placeholder="Nama Lengkap" autocomplete="off" value="<?= $result['nama']; ?>">
    ...
    <div class="form-floating">
      <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="jenis_kelamin">
        ...
        <option value="<?= $result['jenis_kelamin']; ?>">--Pilih Jenis Kelamin--</option>
      </select>
      <label for="floatingSelect">Jenis Kelamin</label>
    </div>
    <br>
    <div class="form-floating">
      <input type="date" name="tanggal_lahir" class="form-control" id="floatingInput" placeholder="Tanggal Lahir" autocomplete="off" value="<?= $result['tanggal_lahir']; ?>">
    ...
    <br>
                                <div class="form-floating">
                                    ...
                                    <option value="<?= $result['prodi']; ?>">--Pilih Jurusan--</option>
                                </select>
                        ...
                        <br>
                                    <div id="ekobis">
                                        ...
                                        <option value="<?= $result['prodi']; ?>">--Pilih Prodi--</option>
                                    </select>
